...
static const char *fonts[]          = { "Iosevka:size=14", "Inconsolata:pixelsize=12:antialias=true:autohint=true"  };
...
static Key keys[] = {
	...
	/* { MODKEY,			XK_m,		spawn,		SHCMD(TERMINAL " -e ncmpcpp; pkill -RTMIN+11 dwmblocks") }, */
	...
	/* { 0, XF86XK_Mail,		spawn,		SHCMD(TERMINAL " -e vim ~/vimwiki/Scratch.md") }, */
	/* { 0, XF86XK_MyComputer,		spawn,		SHCMD(TERMINAL " -e lf /") }, */
	/* { 0, XF86XK_Battery,		spawn,		SHCMD("") }, */
	/* { 0, XF86XK_HomePage,		spawn,		SHCMD("$BROWSER") }, */
	/* { 0, XF86XK_Search,		spawn,	SHCMD(TERMINAL " -e lf") }, */
